...
function addClasses(button){
    ...
    const baseClass = "flex justify-center items-center w-12 h-12 m-1 font-bold py-2 px-2 border hover:border-transparent rounded text-white border-2 text-2xl";
